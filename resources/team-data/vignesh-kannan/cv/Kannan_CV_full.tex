...
\begin{document} \thispagestyle{empty}
	...
	\begin{tabularx}{\textwidth}{@{}l X}
		...
		\href{https://lms.ip-paris.fr/en}{Laboratoire de M{\'e}canique des Solides~(LMS)} & \hfill Phone:~+33 (0) 6 12 91 91 64 \\
		...
		Route de Saclay, 91128 Palaiseau, France & \hfill \href{https://vigneshkannan-group.github.io/vk-mxm-website/}{Research group web page} \\
	\end{tabularx}
	...
	\begin{itemize}[wide, labelwidth=!, labelindent=-1em]
		...
		\end{comment}
		\vspace*{0.5em}
		\item[]\textbf{Senior research associate~(Oberassistent)} \hfill \textit{(June 2022 -- February 2025)} \\
		...
		Department of Mechanical Engineering \& \href{https://hemi.jhu.edu/}{Hopkins Extreme Materials Institute}\\
		Johns Hopkins University, U.S.A. (\textit{Advisor}: Prof.~K.~T.~Ramesh) 
		\begin{comment}
			\begin{itemize}[wide, labelwidth=!, labelindent=0em]
	...
	\begin{itemize}[wide, labelwidth=!, labelindent=-1em]
		\item[]\textbf{European Research Council (ERC) Starting grant} \hfill \textit{(to begin in 2026)}
		\begin{itemize}[wide, labelwidth=!, labelindent=0em]
			\item Five-year grant awarded by the European Research Council to study phase transformations under extreme dynamic conditions
		\end{itemize} 
		\item[]\textbf{Agence Nationale de la Recherche (ANR) Young Researcher grant} \hfill \textit{(October 2025 -- current)}
		\begin{itemize}[wide, labelwidth=!, labelindent=0em]
			\item Four-year grant by the French national research agency (ANR) to study the evolution of phase transformations in magnetic shape memory alloys under extreme dynamic conditions.
		\end{itemize} 
		\item[]\textbf{Peoples' choice best poster award}, Mach conference, Annapolis, MD, U.S.A. \hfill \textit{(April 2017)}
		\begin{itemize}[wide, labelwidth=!, labelindent=0em]
			\item Won by popular vote from about 100 researchers studying the dynamic behavior of materials
	...
	\begin{itemize}[wide, labelwidth=!, labelindent=-1em]
		\item[]\textbf{Assistant Professor, \'{E}cole Polytechnique, France} 
		\begin{itemize}[wide, labelwidth=!, labelindent=0em]
			\item \textit{Mechanics of shape memory alloys under extreme, high-pressure dynamic environments} \\
			\textit{Role}:~Principal Investigator. 
		\end{itemize}
		\vspace*{1em}
		\item[]\textbf{Oberassistent (currently, Visting Scientist), ETH Z\"{u}rich}
		\begin{itemize}[wide, labelwidth=!, labelindent=0em]
	...
	\section*{{Mentorship}}
	\begin{itemize}[wide, labelwidth=!, labelindent=-1em]
		\item[]\textbf{Post-doctoral scientists} \\
		{\'E}cole Polytechnique
		\begin{itemize}[wide, labelwidth=!, labelindent=0em]
			\item Gautam Revankar \hfill \textit{(March 2026 -- present)}
		\end{itemize}
		{\'E}cole Polytechnique
		\begin{itemize}[wide, labelwidth=!, labelindent=0em]
			\item Sameh Ammari (Ph.D. candidate) \hfill \textit{(November 2025 -- present)}
			\item Joao Moreira Lopes (Masters M1) \hfill \textit{(Summer 2025)} 
		\end{itemize}
		ETH Z\"{u}rich
		\begin{itemize}[wide, labelwidth=!, labelindent=0em]
			\item Tom Vreugdenhil, Ph.D. candidate \hfill \textit{(February 2024 -- present)} \\
		...
		{\'E}cole Polytechnique
		\begin{itemize}[wide, labelwidth=!, labelindent=0em]
			\item Cristian Iancu, BS 2026 \hfill \textit{(Spring 2026 )}
			\item Matth{\'e}o Chauvancy, BS 2026 \hfill \textit{(Spring 2026)}
			\item Tamar Tsikarishvili, BS 2025 \hfill \textit{(Spring 2025)}
			\end{itemize}
		ETH Z\"{u}rich
		\begin{itemize}[wide, labelwidth=!, labelindent=0em]
	...
	\begin{itemize}[wide, labelwidth=!, labelindent=-1em]
		\item[]\textbf{{\'E}cole Polytechnique} \\
		Mechanics of solids and structures (undergraduate and graduate level), Experimental mechanics laboratory
	...
	\begin{itemize}[wide, labelwidth=!, labelindent=-1em]
		...
		Journal of Dynamic Behavior of Materials, Mechanics of Materials, International Journal of Impact Engineering, Archive of Applied Mechanics, European Journal of Mechanics A, Experimental Mechanics, Journal of the Mechanics and Physics of Solids
		\vspace*{0.5em}
	...
	\begin{enumerate}[label={[\arabic*]}, leftmargin=*]
		\item \textbf{Vignesh Kannan}, Charles Dorn, Ute Drechsler \emph{\&} Dennis M.~Kochmann, \href{https://doi.org/10.1103/21w4-zn1s}{Microscale architected materials for elastic waveguiding: Fabrication and characterization across length and time scales}, \textit{Phys. Rev. X (2026)}
		\item Charles Dorn*, \textbf{Vignesh Kannan}*, Ute Drechsler \emph{\&} Dennis M.~Kochmann, \href{https://doi.org/10.1038/s41467-026-69888-x}{Graded phononic metamaterials based on scalable microfabrication and design}, \textit{Nature Communications (2026)}
		\item Emil Bronstein, Dotan Ilssar, \textbf{Vignesh Kannan} \emph{\&} Dennis M.~Kochmann, \href{https://doi.org/10.1007/s11340-025-01258-y
		}{Silicon-based microscale multistable metamaterials:~microfabrication and characterization}, \textit{Experimental Mechanics (2025)}
	...
	\begin{enumerate}[label={[\arabic*]}, leftmargin=*]
		\itemsep 5pt
		\item Fabrication and characterization of Si-based
		micro-architected metamaterials for elastic wave guiding, \textit{Institut Jean le Rond d'Alembert, Sorbonne University, France (April 2026)}
		\item Fabrication and characterization of Si-based
		micro-architected metamaterials for elastic wave guiding, \textit{Laboratoire de M{\'e}canique \emph{\&} d'Acoustique, Marseilles, France (June 2025)}
		\item Elastic wave guiding through microarchitected materials, \textit{Indian Institute of Science (IISc), Bengaluru, India (February 2025)}
	...
	\begin{enumerate}[label={[\arabic*]}, leftmargin=*]
		\itemsep 5pt
		\item \textbf{V. Kannan}, C. Dorn, U. Drechsler \emph{\&} D.M. Kochmann, Fabrication and characterization of Si-based
		micro-architected metamaterials for elastic wave guiding, \textit{12th European Solid Mechanics conference, Lyon, France (2025)}
		\item \textbf{V. Kannan}, C. Dorn, U. Drechsler \emph{\&} D.M. Kochmann, Fabrication and characterization of Si-based
		micro-architected metamaterials for elastic wave guiding, \textit{Society for Experimental Mechanics, Milwaukee, U.S.A. (2025)}
