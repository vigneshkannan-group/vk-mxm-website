...
\begin{document}
	...
	The PhD student will design and develop dynamic impact experiments with high-speed instrumentation, to study the macroscopic response and evolution of phase boundaries in SMAs under high strain rates and multi-axial stress states. The resulting data sets will be used to understand the kinetics of phase transformations, and their effect on multi-physical coupling under dynamic loading conditions. 
	...
	\begin{center}
		...
		\textbf{Deadline:~January 31, 2026 at 1800~hrs (Central European Time)}. 
	\end{center}
